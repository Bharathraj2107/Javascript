...
function calculate() {
  ...
  fetch(`https://open.exchangerate-api.com/v6/latest`)
    .then((res) => res.json())//The first.then()converts raw response to JSON
    .then((data) => {//The second .then() processes the parsed JSON and implements application-specific logic.
      console.table(data);
